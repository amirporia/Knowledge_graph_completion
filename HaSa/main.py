...
def main():
    ...
    if args.distributed:
        # Launched via `torchrun --nproc_per_node=N ...`: args.rank/local_rank/
        # world_size were populated from RANK/LOCAL_RANK/WORLD_SIZE in config.py's
        # distributed setup. Mirrors ARPM_KGC/main.py exactly.
